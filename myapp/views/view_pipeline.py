    ...
    def make_container_template(task_name,hubsecret_list=None):
        ...
        if _inject_swanlab:
            ...
            _register_url = conf.get('MLOPS_MONITOR_REGISTER_URL',
                                     'http://10.121.177.93/training_monitor/api/register')
            ...
            #   4. 兜底 local
            _cloud_default_templates = ('hyperparam-search', 'hyperparam-search-nni', 'lightgbm', 'gbdt', 'model-distillation', 'msswift')
